        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              stream: controller.chatStream(authC.user!.value.email! ), //jalankan stream dan ambil email user yang sedang login
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.active) {
                  //jika koenksi terhubung
                  var allChats = (snapshot.data!.data() as Map<String, dynamic>)["chats"]as List;
                  //ambil isi dari snapshot trs ambil data dari firebase kaarena data dari firebase masi object diubah ke mapping trs ambil key chats dan diubah ke bentuk list kenappa akrena memastikan var allchats adalah list dan bisa dapat length dkk
